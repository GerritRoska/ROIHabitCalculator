              ...
              >
                ...
                <div className="mt-8 mb-8 p-8 rounded-xl bg-[#e9f5ff] shadow-[0_8px_16px_rgba(0,75,135,0.08)] text-center transition-all duration-300 max-w-[700px] mx-auto animate-fade-in">
                  <div className="space-y-4">
                    ...
                    <Button
                      className="bg-gradient-to-r from-primary to-accent text-white font-bold px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-sm hover:opacity-90 transition-opacity w-full sm:w-auto text-sm sm:text-base whitespace-normal sm:whitespace-nowrap"
